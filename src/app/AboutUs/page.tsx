...
export default function AboutSection() {
  return (
    <section className="bg-[#f5f5f5] py-10 px-6 lg:px-20">
      ...
      {/* NEW TOP SECTION */}
      <div className="relative overflow-hidden rounded-[40px] py-20 px-6 mb-24 bg-[#FAFAFA]">

        {/* TITLE */}
        <div className="text-center mb-24">

          <h2 className="text-6xl lg:text-7xl font-extrabold text-[#010221] tracking-tight">
            About Us
          </h2>
          ...
          <div className="flex items-center justify-center gap-2 mt-5">
            ...
            <div className="w-16 h-2 rounded-full bg-[#C2D4FF]"></div>

            <div className="w-2.5 h-2.5 rounded-full bg-[#C2D4FF]"></div>
  ...
  <div className="relative z-10 grid md:grid-cols-3 gap-14 mt-24">
    ...
    <div className="text-center relative">
      ...
      <h3 className="text-2xl font-semibold text-[#010221] mt-8">
        The beginning
      </h3>
  ...
  <div className="relative z-10 mt-24 bg-[#dfe4ff] backdrop-blur-md border border-white rounded-[32px] p-10 max-w-5xl mx-auto shadow-sm">
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div className="flex gap-5">
        ...
        <div className="text-6xl text-[#010221]/20 font-bold leading-none">
          “
        </div>

        <p className="text-[#010221] text-lg leading-relaxed font-medium">
          We believe financial management should feel simple,
          modern, and accessible for everyone. That is the future
          we are building with Finans.
        </p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100">
          ...
          <h3 className="text-2xl font-semibold text-[#010221] mb-4">
            Who are we?
          </h3>
